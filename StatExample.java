...
public class StatExample {
    public static void main(String[] args) {
        ...
        try {
            ...
            String sqlD = "CREATE TABLE Department2(Did int PRIMARY KEY, Dname VARCHAR(20))";
            String sqlE = "CREATE TABLE Employee2(Eid int PRIMARY KEY, Ename VARCHAR(20), Salary FLOAT, Address VARCHAR(20), Did int, FOREIGN KEY (Did) REFERENCES Department(Did))";
            stmt.executeUpdate(sqlD);
            stmt.executeUpdate(sqlE);
            System.out.println("Tables created successfully");

            // Step 4: Insert Data into Tables
            String insertSqlD = "INSERT INTO Department2 VALUES(1, 'Finance')";
            String insertSqlE = "INSERT INTO Employee2 VALUES(001, 'Sukanya', 100000.00, 'Hubli', 1)";
            stmt.executeUpdate(insertSqlD);
            stmt.executeUpdate(insertSqlE);
            System.out.println("Data inserted successfully");

            // Step 5: Execute SELECT Queries and Print Results
            String selectSqlE = "SELECT * FROM Employee2";
            ...
            String selectSqlD = "SELECT * FROM Department2";
